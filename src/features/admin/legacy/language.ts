...
const translations: TranslationMap = {
  ...
  Payouts: "การจ่ายเงิน",
  "Top-ups": "การเติมเงิน",
  "Top-up review requires the Admin API": "การตรวจสอบการเติมเงินต้องใช้ Admin API",
  "Connect the Admin API to read Top-up records.": "เชื่อมต่อ Admin API เพื่ออ่านรายการเติมเงิน",
  "Top-up record": "รายการเติมเงิน",
  Credit: "ยอดเงินเข้ากระเป๋า",
  "Payment total": "ยอดชำระทั้งหมด",
  "Member ID": "รหัสสมาชิก",
  "Payment method": "วิธีชำระเงิน",
  "Provider reference": "รหัสอ้างอิงผู้ให้บริการ",
  Expires: "หมดอายุ",
  "Not paid": "ยังไม่ชำระ",
  "Payment timing": "ช่วงเวลาการชำระเงิน",
  "Provider charges": "ค่าธรรมเนียมจากผู้ให้บริการ",
  "Provider fee": "ค่าธรรมเนียมผู้ให้บริการ",
  "Provider tax": "ภาษีผู้ให้บริการ",
  "Reconcile with provider": "ตรวจสอบกับผู้ให้บริการ",
  Expired: "หมดอายุ",
  Users: "ผู้ใช้",
  Wallets: "กระเป๋าเงิน",
  Member: "สมาชิก",
  ...
  "Created timestamp": "เวลาที่สร้าง",
  "Load more": "โหลดเพิ่ม",
  ...
  Showing: "แสดง",
  "latest dispute/report records": "รายการข้อพิพาท/รายงานล่าสุด",
  ...
  "Mock data shown for missing API fields": "แสดงข้อมูลจำลองสำหรับฟิลด์ที่ Admin API ไม่ได้ส่งมา",
  "The Admin API does not return these fields. The values below are for UI review only and are not sent to the API.": "Admin API ไม่ได้ส่งฟิลด์เหล่านี้ ค่าด้านล่างใช้สำหรับตรวจสอบหน้าจอเท่านั้น และจะไม่ส่งไปยัง API",
  "Pending resolution amount": "จำนวนเงินที่รอการตัดสินใจ",
  "Hirer and Worker display names": "ชื่อที่แสดงของ Hirer และ Worker",
  "Dispute category": "หมวดหมู่ข้อพิพาท",
  "Participant claim and response": "คำกล่าวอ้างและคำตอบของผู้เข้าร่วม",
  "Applicable policy guidance": "แนวทางนโยบายที่เกี่ยวข้อง",
  "Admin review recommendation": "คำแนะนำสำหรับการตรวจสอบของ Admin",
  "Available queue counts only": "แสดงเฉพาะจำนวนคิวที่มีอยู่",
  "Items requiring admin action": "รายการที่ต้องดำเนินการโดยผู้ดูแล",
  "Queue summary only": "แสดงเฉพาะสรุปคิว",
  "Detailed review records are not provided by the Admin API.": "Admin API ไม่ได้ส่งรายการตรวจสอบโดยละเอียด",
  "Detailed payout records are not provided by the Admin API.": "Admin API ไม่ได้ส่งรายการจ่ายเงินโดยละเอียด",
  "Detailed member records are not provided by the Admin API.": "Admin API ไม่ได้ส่งข้อมูลสมาชิกโดยละเอียด",
  ...
  "No payouts need review": "ไม่มีการจ่ายเงินที่ต้องตรวจสอบ",
  "Processing and completed payouts are moving normally.": "การจ่ายเงินที่กำลังดำเนินการและเสร็จสิ้นเป็นไปตามปกติ",
  "No user reviews": "ไม่มีผู้ใช้ที่ต้องตรวจสอบ",
  "All accounts are currently in good standing.": "บัญชีทั้งหมดอยู่ในสถานะปกติในขณะนี้",
  ...
  "Permanent all-quest ban": "ระงับการทำงานทุกงานถาวร",
  ...
  QUEST_IN_PROGRESS: "กำลังดำเนินการ",
  QUEST_COMPLETED: "เสร็จสิ้น",
  QUEST_CANCELLED: "ยกเลิก",
  QUEST_FAILED: "ล้มเหลว",
  DISPUTE_CASE_PENDING: "เปิด",
  DISPUTE_CASE_DISMISSED: "ยกเลิกแล้ว",
  DISPUTE_CASE_RESOLVED: "แก้ไขแล้ว",
  REPORT_CASE_PENDING: "เปิด",
  REPORT_CASE_DISMISSED: "ยกเลิกแล้ว",
  REPORT_CASE_HIDDEN: "ยืนยันแล้ว",
  REPORT_CASE_RESTORED: "กู้คืนแล้ว",
  CONDUCT_REPORT_PENDING: "เปิด",
  CONDUCT_REPORT_UPHELD: "ยืนยันแล้ว",
  CONDUCT_REPORT_DISMISSED: "ยกเลิกแล้ว",
  PENDING_ADMIN_APPROVAL: "รอตรวจสอบ",
  SUBMITTED_TO_PROVIDER: "ส่งแล้ว",
  PROVIDER_PENDING: "กำลังดำเนินการ",
  SUCCEEDED: "จ่ายแล้ว",
  FAILED: "ล้มเหลว",
  CANCELLED: "ยกเลิก",
  ACTIVE: "ใช้งานอยู่",
  ...
  "Review reports about Message or Attachment content.": "ตรวจสอบรายงานเกี่ยวกับเนื้อหาข้อความหรือไฟล์แนบ",
  "Review Member behavior on Quests.": "ตรวจสอบพฤติกรรมของสมาชิกในงาน",
  "An audit trail of administrative decisions.": "ประวัติการตรวจสอบการตัดสินใจของผู้ดูแลระบบ",
  ...
  "Reported member": "สมาชิกที่ถูกรายงาน",
  "Conduct report": "รายงานพฤติกรรม",
  "Submitted by": "ส่งโดย",
  Reason: "เหตุผล",
  ...
  "Candidate selection": "คัดเลือกผู้สมัคร",
  Single: "เดี่ยว",
  Team: "ทีม",
  FCFS: "มาก่อนได้ก่อน",
...
const patternTranslations: PatternTranslation[] = [
  ...
  [/^(.+) · Mock data$/, (match) => `${match[1]} · ข้อมูลจำลอง`],
  ...
  [/^REPORT_CASE_PENDING (\d+) · Closed cases (\d+)$/, (match) => `REPORT_CASE_PENDING ${match[1]} · คดีปิดแล้ว ${match[2]}`],
  [/^Earning sources · (\d+)$/, (match) => `แหล่งรายได้ · ${match[1]}`],
  [/^((?:Individual|Team) quest) · Quest State: (.+)$/, (match) => `${match[1] === "Individual quest" ? "งานเดี่ยว" : "งานทีม"} · สถานะงาน: ${match[2]}`],
  ...
  [/^(\d+) minutes? ago$/, (match) => `${match[1]} นาทีที่แล้ว`],
  [/^(\d+) hours? ago$/, (match) => `${match[1]} ชั่วโมงที่แล้ว`],
  [/^(\d+) loaded entries$/, (match) => `โหลดแล้ว ${match[1]} รายการ`],
