...
export function WalletStatementTable({ transactions }: { transactions: WalletLedgerView[] }) {
  ...
  return <div className="wallet-statement-table-block">
    <p className="wallet-statement-scroll-hint">On narrow screens, scroll horizontally to view all Wallet Statement columns.</p>
    <section className="table-wrap wallet-statement-table-wrap" aria-label="Wallet Statement table">
